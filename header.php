...
{
?>
    <img src="assets/images/moodule_logo_white.png" alt="présentation du logo de la page web">
<?php
}
else{
?>
        <img src="assets/images/moodule_logo.png" alt="présentation du logo de la page web">
<?php
}
}
else{
