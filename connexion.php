...
?>  
    ...
    <video id="video_background_connect" playsinline autoplay muted>
        <source src=".\assets\images\background_connect_animation.mp4" type="video/mp4">
    </video>
    <main>
    <div  class="div_design_mdc">
    <img id="mdc_top_connect"src="assets/images/moodule_top_mdc_connect.png" alt="test">
    </div>
<?php
...
?>
    ...
    <div  class="div_design_mdc">
    <img id="mdc_bottom_connect"src="assets/images/moodule_bottom_mdc_connect.png" alt="test">
    </div>
    </main>
    <footer>
<?php
